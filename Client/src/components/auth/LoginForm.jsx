    ...
    <div className="min-h-screen w-full flex">
        ...
        <div className="w-full max-w-md p-6 space-y-6 relative z-10">
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                >
                  {showPassword ? (
                    <svg className="h-5 w-5 text-gray-400 hover:text-indigo-500 transition-colors" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="text-center pt-4">
            <p className="text-sm text-gray-500">
              &copy; {new Date().getFullYear()} Mate & Mentors. All rights reserved.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center px-12 max-w-lg">
          <div className="mb-8">
            <img src={bannerPath} alt="Mate & Mentors" className="w-48 h-48 mx-auto rounded-3xl shadow-2xl" />
          </div>
          <h2 className="text-3xl font-bold text-white mb-4">
            Empower Your Journey
          </h2>
          <p className="text-indigo-100 text-lg leading-relaxed">
            Connect with mentors who guide you towards success. Join our community of learners and achievers.
          </p>
